...
public class FuncionarioListagem extends javax.swing.JDialog {
    ...
    public void carregarFuncionarios() {
        try {
            funcionarios = new FuncionarioUC().listar();
            ...
            for (int i = 0; i < funcionarios.size(); i++) {
                ...
                linhas[i][1] = funcionarios.get(i).getCargo();
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new FuncionarioEditor(new javax.swing.JFrame(), true).setVisible(true);
        carregarFuncionarios();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            new FuncionarioEditor(new javax.swing.JFrame(), true, funcionarios.get(indice)).setVisible(true);
            carregarFuncionarios();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            Integer indice = jTable1.getSelectedRow();
            FuncionarioUC.remover(funcionarios.get(indice).getId());
            carregarFuncionarios();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
